...
const es = {
  ...
  config: {
    ...
    companyNamePlaceholder: "Ej: Mi Valet",
    logo: "Logo",
...
/** Estructura de claves igual a es; valores como string para permitir cualquier idioma */
...
const en: TranslationKeys = {
  ...
  config: {
    ...
    companyNamePlaceholder: "E.g.: My Valet",
    logo: "Logo",
